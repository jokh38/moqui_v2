...
print_node_specification_gpu(mqi::node_t<R>* node) {
    ...
    printf("Node specification of GPU printing.. : X --> %.3f to %.3f \n", x[0], x[dim.x]);
    printf("Node specification of GPU printing.. : Y --> %.3f to %.3f \n", y[0], y[dim.y]);
    printf("Node specification of GPU printing.. : Z --> %.3f to %.3f \n", z[0], z[dim.z]);
    ...
    printf("Node specification of GPU printing.. : Phantom position --> (%d, %d, %d): %f\n", idx.x, idx.y, idx.z, v);
    printf("Node specification of GPU printing.. : Number of children --> %d\n", node->n_children);
...
print_node_specification(mqi::node_t<R>* node) {
    ...
    printf("Node specification of CPU printing.. : X --> %.3f to %.3f \n", x[0], x[dim.x]);
    printf("Node specification of CPU printing.. : Y --> %.3f to %.3f \n", y[0], y[dim.y]);
    printf("Node specification of CPU printing.. : Z --> %.3f to %.3f \n", z[0], z[dim.z]);
    ...
    printf("Node specification of CPU printing.. : Phantom position --> (%d, %d, %d): %f\n", idx.x, idx.y, idx.z, v);
    printf("Node specification of CPU printing.. : Number of children --> %d\n", node->n_children);
    for (int i = 0; i < node->n_children; ++i) {
